...
public class Serveur {
	...
	public static void envoiePlateau() {
		sortie.println(ctrl.getPlateauJoueur().toString());
	}

	public static void envoieCoup(int x, int y) {
		sortie.println(x + ":" + y);
	}

	private static void receptionPlateau(String s) {
		ctrl.ajouterPlateauAdv(s);
	}

	private static void jouerCoup(String s) {
		frmJeu.envoyerLogScoreA(ctrl.advJoue(s));
	}

	public static void setCoup(int[] tab) {
		coup = tab;
	}
}
