 ...
 * Elle contrôle les interactions entre le joueur, le robot (adversaire), et l'interface utilisateur.
 *
...
{
	/**
	 * Une référence à la classe Robot, utilisée pour simuler l'entrée de l'utilisateur.
	 */
	private Robot rbt;
