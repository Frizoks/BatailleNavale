...
public class FrameAccueil extends JFrame implements ActionListener
{
	...
	public FrameAccueil(Controleur ctrl)
	{
		...
		this.btnMusique = new JButton("Musique ON/OFF");
		this.btnQuitter = new JButton("Quitter");

		this.btnSolo.setBounds(233, 165, 233, 25);
		this.btnHeberger.setBounds(233, 200, 233, 25);
		this.btnRejoindre.setBounds(233, 235, 233, 25);
		this.btnMusique.setBounds(233, 305, 233, 25);
		this.btnQuitter.setBounds(233, 340, 233, 25);

		if(!Sound.musiquePossible()) {this.btnMusique.setEnabled(false);}

		this.add(this.btnSolo);
		this.add(this.btnHeberger);
		this.add(this.btnRejoindre);
		this.add(this.btnMusique);
		...
		this.btnMusique.addActionListener(this);
	...
	{
		if (e.getSource() == this.btnMusique)
		{
			Sound.soundOnOff();
			return;
		}
