...
public class PanelJeu extends JPanel implements MouseListener
{
	...
	/**
	 * Cette méthode envoie les log du joueur en fonction du coup joué.
	 *
	...
	public void envoyerLogScoreJ(char coup, int x, int y)
	{
		...
		((PanelMessage) this.frmJeu.pnlBas).ajouterScoreJ("Vous avez coulé " + this.frmJeu.getCtrl().getNbNaviresCouleJoueur(),
	...
	public void envoyerLogScoreA(char coup)
	{
		...
		((PanelMessage) this.frmJeu.pnlBas).ajouterScoreA("Votre adversaire a coulé " + this.frmJeu.getCtrl().getNbNaviresCouleAdv(),
