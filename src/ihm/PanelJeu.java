	...
	public void afficherAdv(Graphics2D g2)
	{
		for (Cellule[] tab : this.frmJeu.getCtrl().getPlateauAdv().getGrille()) {
			for (Cellule cell : tab) {
				...
				else if(cell.getTirer() && !cell.getNavire()) {g2.drawImage(new ImageIcon ( this.getClass().getResource("image/tirEau.png")).getImage(),402+cell.getX()*25,77+cell.getY()*25,21,21,this);}
