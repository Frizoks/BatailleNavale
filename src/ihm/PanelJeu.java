			...
			for (Cellule cell : tab) {
				if (this.frmJeu.getCtrl().getPlateauJoueur().getCellule(cell.getX(),cell.getY()).getNavire())
				{
					switch (this.frmJeu.getCtrl().getPlateauJoueur().extremite(cell.getX(),cell.getY())) {
						case 'G':
							g2.drawImage(new ImageIcon ( this.getClass().getResource( "image/navireExtremiteGplace.png" )).getImage(),52+cell.getX()*25,77+cell.getY()*25,21,21,this);
							break;
						case 'D':
							g2.drawImage(new ImageIcon ( this.getClass().getResource( "image/navireExtremiteDplace.png" )).getImage(),52+cell.getX()*25,77+cell.getY()*25,21,21,this);
							break;
						case 'H':
							g2.drawImage(new ImageIcon ( this.getClass().getResource( "image/navireExtremiteHplace.png" )).getImage(),52+cell.getX()*25,77+cell.getY()*25,21,21,this);
							break;
						case 'B':
							g2.drawImage(new ImageIcon ( this.getClass().getResource( "image/navireExtremiteBplace.png" )).getImage(),52+cell.getX()*25,77+cell.getY()*25,21,21,this);
							break;
			...
			for (Cellule cell : tab) {
				if (this.frmJeu.getCtrl().getPlateauAdv().navireEntier(cell.getX(),cell.getY()))
				{
					switch (this.frmJeu.getCtrl().getPlateauAdv().extremite(cell.getX(),cell.getY())) {
						case 'G':
							g2.drawImage(new ImageIcon ( this.getClass().getResource( "image/navireExtremiteG.png" )).getImage(),402+cell.getX()*25,77+cell.getY()*25,21,21,this);
							break;
						case 'D':
							g2.drawImage(new ImageIcon ( this.getClass().getResource( "image/navireExtremiteD.png" )).getImage(),402+cell.getX()*25,77+cell.getY()*25,21,21,this);
							break;
						case 'H':
							g2.drawImage(new ImageIcon ( this.getClass().getResource( "image/navireExtremiteH.png" )).getImage(),402+cell.getX()*25,77+cell.getY()*25,21,21,this);
							break;
						case 'B':
							g2.drawImage(new ImageIcon ( this.getClass().getResource( "image/navireExtremiteB.png" )).getImage(),402+cell.getX()*25,77+cell.getY()*25,21,21,this);
							break;
